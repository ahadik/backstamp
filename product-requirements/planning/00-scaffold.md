...
- Full import pipeline with metadata reading (Phase 2)
- Photo grid with day blocks, selection, drag-and-drop (Phase 3)
- Inspector Panel fields with live editing (Phase 4)
- Apply / Rollback / Reset pipeline (Phase 5)
- Map Panel (Mapbox) + Location section (Phase 6)
- GPX import and auto-tagging (Phase 7)
- Camera/Lens/Film corpus UI (Phase 8)
- Vibe Tag / Claude integration (Phase 9)
- Session persistence and restore (Phase 10)
