...
- Photo context menu (Phase 7)
- Map Panel (Mapbox) + Location section (Phase 8)
- GPX import and auto-tagging (Phase 9)
- Camera/Lens/Film corpus UI (Phase 10)
- Vibe Tag / Claude integration (Phase 11)
- Session persistence and restore (Phase 12)
