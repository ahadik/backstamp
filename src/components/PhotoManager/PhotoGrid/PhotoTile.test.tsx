...
describe("PhotoTile", () => {
  describe("when fileStatus is ok", () => {
    it("renders an img element", () => {
      render(<PhotoTile photo={makePhoto()} tilePx={200} />);
  ...
  describe("when fileStatus is missing", () => {
    it("renders the File not found text", () => {
      render(<PhotoTile photo={makePhoto({ fileStatus: "missing" })} tilePx={200} />);
  ...
  describe("pending dot", () => {
    it("is absent when pendingChanges is null", () => {
      const { container } = render(<PhotoTile photo={makePhoto()} tilePx={200} />);
    ...
    it("is present when pendingChanges is non-null", () => {
      ...
      const { container } = render(<PhotoTile photo={photo} tilePx={200} />);
      const spans = container.querySelectorAll("span");
